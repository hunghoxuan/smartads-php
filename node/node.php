...
define("NODE_DIR", "/usr/local/bin"); //Linux
//define("NODE_DIR", "C:\\Program Files\\nodejs"); //Windows

define("NODE_PORT", 8890);
...
function node_npm($cmd) {
    ...
    $cmd = escapeshellcmd(NODE_DIR . "/npm --cache ./.npm -- $cmd");
    echo "Running: $cmd\n";
    $ret = -1;
    passthru($cmd, $ret);
...
function node_foot() {
    echo '</pre><p>' . \common\components\FHtml::getAuthorPowerByMessage() . '</p></body></html>';
}
