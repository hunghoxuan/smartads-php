...
class Generator extends \yii\gii\Generator
{
    ...
    public function generateActiveFieldAdvanced($attribute)
    {
        ...
        if ($column->phpType === 'boolean') {
        ...
        } elseif ($column->type == "string" && ($column->size == 500 || $column->size == 1000)){
            ...
            elseif ($column->phpType !== 'string' || $column->size === null) {
                    ...
                    if ($column->dbType === 'tinyint(1)') {
                        ...
                        return "\$form->field(\$model, '$attribute')->widget(CheckboxX::classname(), ['options' => ['value' => 1], 'pluginOptions' => ['theme' => 'krajee-flatblue', 'size' => 'md', 'threeState' => false]])";
                    ...
                    elseif($column->type == 'datetime'){
                        ...
                        if(self::getDataForActiveFieldWithComment($attribute) != false){
                            return self::getDataForActiveFieldWithComment($attribute);
                        }else{
                            return "\$form->field(\$model, '$attribute')->$input()";
                        }
                    }
            }
            //var char with length
            else {
                if(self::getDataForActiveFieldWithComment($attribute) != false){
                    return self::getDataForActiveFieldWithComment($attribute);
                }else {
    ...
    public function getDataForActiveFieldWithComment($attribute){
        ...
        if(strlen($column->comment)!=0 AND  $keyword != false){
            ...
            }else if ($keyword == Helper::LOOKUP_KEYWORD){
