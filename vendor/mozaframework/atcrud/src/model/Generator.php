...
namespace mozaframework\atcrud\model;
 ...
 * @since 2.0
 */
class Generator extends \mozaframework\atcrud\Generator
{
    ...
    public function hints()
    {
        return array_merge(parent::hints(), [
            ...
            'tableName' => 'This is the name of the DB table that the new ActiveRecord class is associated with, e.g. <code>post</code>.
                ...
                class.<br/>Input <code>table_name_1, table_name_2</code> etc and more if you want to generate models for multiple table at the same time, all of them will be generated under same namespace',
...
//            $files[] = new CodeFile(
//                Yii::getAlias('@' . str_replace('models', 'actions', str_replace('\\', '/', $this->ns))) . '/' . $modelClassName . 'Action.php',
...
//            );
            ...
            $files[] = new CodeFile(
                str_replace('/models','/setup', Yii::getAlias('@' . str_replace('\\', '/', $this->ns))) . '/' . $tableName . '.sql',
...
//        }
    ...
    protected function getTableNames()
    {
        ...
        if (!isset($this->tableNameArray)) {
            $arrays = explode(',', Helper::prepareStringForExplode($this->tableName));
            $this->tableNameArray = [];
...
//        }
    ...
    public function generateSearchConditions($searchExact = false, $table = null)
    {
        ...
        if (!empty($likeConditions)) {
            $conditions[] = str_repeat(' ', 4) . "\$query" . implode("\n" . str_repeat(' ', 16), $likeConditions) . ";\n";
        }
