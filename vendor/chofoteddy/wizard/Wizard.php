...
class Wizard extends \yii\bootstrap\Widget
{
    ...
    public function run()
    {
        ...
        if ($this->progressType == true) {
            FHtml::registerJs("$(document).ready(function() {
            $('#$this->id').bootstrapWizard({onTabShow: function(tab, navigation, index) {
        ...
        return implode("\n", [
            ...
            $this->progressType == true ? '<div id="bar" class="progress">
    ...
    public function renderItems()
    {
        ...
        $result = Nav::widget(['items' => $labels, 'options' => $this->navOptions])
            . Html::tag(
                'div',
                implode("\n", $contents) . $this->renderPrevNextButtons(),
                ['class' => 'tab-content']
            );
    ...
    protected function renderPrevNextButtons() {
        return false;
        return '<ul class="pager wizard">
