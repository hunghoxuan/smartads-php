...
class Security extends Component
{
     ...
     * - 'password' - use of PHP `password_hash()` function with PASSWORD_DEFAULT algorithm.
     ...
     * the output is always 60 ASCII characters, when set to 'password' the output length
    ...
    public function validatePassword($password, $hash)
    {
        ...
        if (function_exists('password_verify')) {
            ...
            //echo $result; echo '-'; echo $password; echo '-'; echo $test;  echo '-'; echo $hash; die;
