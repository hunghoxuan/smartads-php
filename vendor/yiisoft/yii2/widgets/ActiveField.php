...
class ActiveField extends Component
{
    ...
    public function select($items = null, $options = [], $lookup_object = '', $populated_fields = [], $search_field = 'name', $id_field = 'id', $class = FHtml::EDITOR_SELECT)
    {
        ...
        $config['attribute'] = $this->attribute;
        $config['view'] = $this->form->getView();
        $this->object_type = app()->getTableName($this->model);

        if (!isset($items))
            $items = app()->getComboArray($this->attribute, $this->object_type, $this->attribute, true);
        ...
        if (!empty($lookup_object))  {
            $config = array_merge($config, app()->getSelect2Options($this->object_type, $populated_fields, $lookup_object, $search_field, $id_field));
    ...
    public function selectLookup($object_type, $options = [], $populated_fields = [], $search_field = 'name', $id_field = 'id') {
        return self::select(null, $options, $object_type, $populated_fields, $search_field, $id_field, FHelper::EDITOR_SELECT);
    }

    public $object_type;
    public function selectMany($items = null, $options = [], $lookup_object = '', $populated_fields = [], $search_field = 'name', $id_field = 'id', $class = FHelper::EDITOR_SELECT)
    {
        $options = array_merge($this->inputOptions, $options);
        $this->adjustLabelFor($options);
        /* @var $class \yii\base\Widget */
    ...
    public function selectManyLookup($object_type, $options = [], $populated_fields = [], $search_field = 'name', $id_field = 'id') {
        return self::selectMany(null, $options, $object_type, $populated_fields, $search_field, $id_field, FHelper::EDITOR_SELECT);
    }

    public function selectMultiple($items = null, $options = [], $lookup_object = '', $populated_fields = [], $search_field = 'name', $id_field = 'id', $class = FHelper::EDITOR_SELECT)
    {
        return self::selectMany($items, $options, $lookup_object, $populated_fields, $search_field, $id_field, $class);
    }


    public function date($format = 'yyyy-mm-dd', $options = [], $disabled_date = '0,6', $disabled_hours = '0, 1', $class = FHelper::EDITOR_DATE)
    {
        $options = array_merge($this->inputOptions, $options);
        $this->adjustLabelFor($options);
        /* @var $class \yii\base\Widget */
    ...
    public function datetime($format = 'yyyy-mm-dd hh:ii', $options = [], $disabled_date = '0,6', $disabled_hours = '0, 1',  $class = FHelper::EDITOR_DATETIME)
    {
        return self::date($format, $options, $disabled_date, $disabled_hours, $class);
    }

    public function html($options = ['rows' => 5, 'disabled' => false], $preset = 'normal', $class = FHelper::EDITOR_HTML)
    {
        $options = array_merge($this->inputOptions, $options);
        $this->adjustLabelFor($options);
        /* @var $class \yii\base\Widget */
    ...
    public function fckeditor($options = ['rows' => 5, 'disabled' => false], $preset = 'normal', $class = FHelper::EDITOR_HTML)
    {
        return self::html($options, $preset, $class);
    }

    public function boolean($options = [], $class = FHelper::EDITOR_SWITCH)
    {
        return self::checkbox($options, $class);
    }


    public function numeric($options = [], $class = FHelper::EDITOR_NUMERIC)
    {
    ...
    public function numericInput($options = [], $class = FHelper::EDITOR_NUMERIC)
    {
        return self::numeric($options, $class);
    }

    public function currency($prefix = '', $options = [], $class = FHelper::EDITOR_NUMERIC)
    {
        if (empty($prefix))
            $prefix = app()->settingCurrency();
    ...
    public function currencyInput($prefix = '', $options = [], $class = FHelper::EDITOR_NUMERIC)
    {
        return self::currency($prefix, $options, $class);
    }

    public function moneyInput($prefix = '', $options = [], $class = FHelper::EDITOR_NUMERIC)
    {
        return self::currency($prefix, $options, $class);
    }

    public function money($prefix = '', $options = [], $class = FHelper::EDITOR_NUMERIC)
    {
        return self::currency($prefix, $options, $class);
    }

    public function emailInput($options = [], $class = FHelper::EDITOR_NUMERIC)
    {
        $options = array_merge($options, ['clientOptions' => ['alias' =>  'email']]);
        return self::currency($options, $class);
    }

    public function email($options = [], $class = FHelper::EDITOR_NUMERIC)
    {
        return self::emailInput($options, $class);
    }

    public function urlInput($options = [], $class = FHelper::EDITOR_NUMERIC)
    {
        $options = array_merge($options, ['clientOptions' => ['alias' =>  'url']]);
        return self::currency($options, $class);
    }

    public function url($options = [], $class = FHelper::EDITOR_NUMERIC)
    {
        return self::urlInput($options, $class);
    }

    public function maskedInput($masked = '', $class = FHelper::EDITOR_NUMERIC)
    {
        $options = ['mask' => $masked];
        return self::maskedInput($class, $options);
    }

    public function rate($count = 5, $min = 0, $max = 5, $step = 1, $starCaptions = [], $class = FHelper::EDITOR_RATE)
    {
    ...
    public function star($count = 5, $min = 0, $max = 5, $step = 1, $starCaptions = [], $class = FHelper::EDITOR_RATE)
    {
        return self::rate($count, $min, $max, $step, $starCaptions, $class);
    }

    public function slide($min = 0, $max = 100, $step = 1, $class = FHelper::EDITOR_SLIDE)
    {
        $options = ['sliderColor'=> 'grey', 'handleColor'=> 'danger', 'pluginOptions'=>['min'=>$min,'max'=>$max,'step'=>15]];
        return self::widget($class, $options);
    }

    public function progress($min = 0, $max = 100, $step = 1, $class = FHelper::EDITOR_SLIDE)
    {
        $options = ['sliderColor'=> 'grey', 'handleColor'=> 'danger', 'pluginOptions'=>['min'=>$min,'max'=>$max,'step'=>15]];
        return self::widget($class, $options);
    }

    public function color($class = FHelper::EDITOR_COLOR)
    {
        $options = [];
        return self::widget($class, $options);
    }
