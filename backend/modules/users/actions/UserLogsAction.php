...
use backend\modules\users\models\UserLogsAPI;
 ...
 */
class UserLogsAction extends BaseApiAction
{
    ...
    public function run()
    {
        ...
        if (!empty($this->objectid)) {
            ...
            $object = UserLogsAPI::findOne($this->objectid);
            ...
            $list = UserLogsAPI::getDataProvider(Fhtml::mergeRequestParams(['name' => '%'.$this->keyword], $this->paramsArray), $this->orderby, $this->limit, $this->page, false);
