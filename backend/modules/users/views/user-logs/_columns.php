...
//    ],
    [ //name: id, dbType: bigint(20), phpType: string, size: 20, allowNull:
        ...
        'attribute'=>'id',
        'visible' => true,
        'value' => function($model) { return '<b>' . FHtml::showContent($model-> id, FHtml::SHOW_NUMBER, 'user_logs', 'id','bigint(20)','user-logs') . '</b>' ; },
        'hAlign'=>'center',
        'vAlign'=>'middle',
        'width'=>'50px',
    ],
    [ //name: created_date, dbType: timestamp, phpType: string, size: , allowNull: 1
        ...
        'label' => 'Start',
        'visible' => true,
        'value' => function($model) { return FHtml::showDateTime($model-> created_date, '', 'user_logs', 'created_date','timestamp','user-logs'); },
        'hAlign'=>'right',
        'vAlign'=>'middle',
...
//    ],
    [ //name: user_id, dbType: varchar(100), phpType: string, size: 100, allowNull:
        ...
        'attribute'=>'user_id',
        'visible' => true,
        'value' => function($model) { return FHtml::showContent($model-> user_id, FHtml::SHOW_LOOKUP, '@user', 'user_id','varchar(100)','user-logs'); },
        'hAlign'=>'left',
        'vAlign'=>'middle',
        'contentOptions'=>['class'=>'col-md-1 nowrap'],
    ...
    [ //name: object_type, dbType: varchar(255), phpType: string, size: 255, allowNull: 1
        ...
        'visible' => true,
        'value' => function($model) { return FHtml::showContent($model-> object_type, FHtml::SHOW_LABEL, 'user_logs', 'object_type','varchar(255)','user-logs') . ' #' . $model->object_id; },
        'hAlign'=>'left',
        'vAlign'=>'middle',
        'width'=>'100px',
        'filterType' => GridView::FILTER_SELECT2,
...
//    ],
    ...
    [ //name: created_date, dbType: timestamp, phpType: string, size: , allowNull: 1
        ...
        'label' => 'End',
        'visible' => true,
        'value' => function($model) { return FHtml::showDateTime($model-> modified_date, '', 'user_logs', 'modified_date','timestamp','user-logs'); },
        'hAlign'=>'right',
        'vAlign'=>'middle',
        'contentOptions'=>['class'=>'col-md-1 nowrap'],
    ],
