...
return [
    ...
    [ //name: is_active, dbType: tinyint(4), phpType: integer, size: 4, allowNull: 1 
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->is_active, FHtml::SHOW_BOOLEAN, 'user_feedback', 'is_active', 'tinyint(4)', 'user-feedback');
        },
        'hAlign' => 'right',
        'vAlign' => 'middle',
        'width' => '20px',
    ...
    [ //name: type, dbType: varchar(100), phpType: string, size: 100, allowNull: 1 
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->type, FHtml::SHOW_LABEL, 'user_feedback', 'type', 'varchar(100)', 'user-feedback');
        },
        'hAlign' => 'left',
        'vAlign' => 'middle',
        'width' => '80px',
    ...
    [ //name: status, dbType: varchar(100), phpType: string, size: 100, allowNull: 1 
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->status, FHtml::SHOW_LABEL, 'user_feedback', 'status', 'varchar(100)', 'user-feedback');
        },
        'hAlign' => 'left',
        'vAlign' => 'middle',
        'width' => '80px',
    ...
    [ //name: user_id, dbType: varchar(100), phpType: string, size: 100, allowNull:
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->user_id, FHtml::SHOW_LOOKUP, '@app_user', 'user_id', 'varchar(100)', 'user-feedback');
        },
        'hAlign' => 'left',
        'vAlign' => 'middle',
        'contentOptions' => ['class' => 'col-md-1 nowrap'],
