...
//        'value' => function($model) { return '<b>' . FHtml::showContent($model-> id, FHtml::SHOW_NUMBER, 'user_feedback', 'id','int(11)','user-feedback') . '</b>' ; },
//        'hAlign'=>'center',
//        'vAlign'=>'middle',
//        'width'=>'50px',
//    ],
...
//        'value' => function($model) { return FHtml::showContent($model-> object_id, FHtml::SHOW_LABEL, 'user_feedback', 'object_id','varchar(100)','user-feedback'); },
//        'hAlign'=>'left',
//        'vAlign'=>'middle',
//        'width'=>'80px',
...
//        'filter'=> FHtml::getComboArray('user_feedback', 'user_feedback', 'object_id', true, 'id', 'name'),
//    ],
...
//        'value' => function($model) { return FHtml::showContent($model-> object_type, FHtml::SHOW_LABEL, 'user_feedback', 'object_type','varchar(100)','user-feedback'); },
//        'hAlign'=>'left',
//        'vAlign'=>'middle',
//        'width'=>'80px',
//        'filterType' => GridView::FILTER_SELECT2,
...
//                            ],
//        'filterInputOptions'=>['placeholder'=>''],
//        'filter'=> FHtml::getComboArray('user_feedback', 'user_feedback', 'object_type', true, 'id', 'name'),
//    ],
    [ //name: name, dbType: varchar(200), phpType: string, size: 200, allowNull:  
    ...
    [ //name: email, dbType: varchar(200), phpType: string, size: 200, allowNull:  
    ...
    [ //name: is_active, dbType: tinyint(4), phpType: integer, size: 4, allowNull: 1 
        ...
        'value' => function($model) { return FHtml::showContent($model-> is_active, FHtml::SHOW_BOOLEAN, 'user_feedback', 'is_active','tinyint(4)','user-feedback'); }, 
        'hAlign'=>'right',
        'vAlign'=>'middle',
        'width'=>'20px',
        'editableOptions'=>[                       
...
//        'value' => function($model) { return FHtml::showContent($model-> response, '', 'user_feedback', 'response','text','user-feedback'); },
//        'hAlign'=>'right',
//        'vAlign'=>'middle',
//        'contentOptions'=>['class'=>'col-md-1 nowrap'],
//    ],
    [ //name: type, dbType: varchar(100), phpType: string, size: 100, allowNull: 1 
        ...
        'value' => function($model) { return FHtml::showContent($model-> type, FHtml::SHOW_LABEL, 'user_feedback', 'type','varchar(100)','user-feedback'); }, 
        'hAlign'=>'left',
        'vAlign'=>'middle',
        'width'=>'80px',
        'filterType' => GridView::FILTER_SELECT2, 
        ...
        'filterInputOptions'=>['placeholder'=>''],
        'filter'=> FHtml::getComboArray('user_feedback', 'user_feedback', 'type', true, 'id', 'name'),
    ],
    [ //name: status, dbType: varchar(100), phpType: string, size: 100, allowNull: 1 
        ...
        'value' => function($model) { return FHtml::showContent($model-> status, FHtml::SHOW_LABEL, 'user_feedback', 'status','varchar(100)','user-feedback'); }, 
        'hAlign'=>'left',
        'vAlign'=>'middle',
        'width'=>'80px',
        'filterType' => GridView::FILTER_SELECT2, 
        ...
        'filterInputOptions'=>['placeholder'=>''],
        'filter'=> FHtml::getComboArray('user_feedback', 'user_feedback', 'status', true, 'id', 'name'),
    ],
    [ //name: user_id, dbType: varchar(100), phpType: string, size: 100, allowNull:
        ...
        'value' => function($model) { return FHtml::showContent($model-> user_id, FHtml::SHOW_LOOKUP, '@app_user', 'user_id','varchar(100)','user-feedback'); },
        'hAlign'=>'left',
        'vAlign'=>'middle',
        'contentOptions'=>['class'=>'col-md-1 nowrap'],
        'filterType' => GridView::FILTER_SELECT2,
    ...
    //[ //name: created_user, dbType: varchar(100), phpType: string, size: 100, allowNull: 1 
        ...
        //'value' => function($model) { return FHtml::showContent($model-> created_user, FHtml::SHOW_LABEL, 'user_feedback', 'created_user','varchar(100)','user-feedback'); }, 
        //'hAlign'=>'left',
        //'vAlign'=>'middle',
        //'width'=>'80px',
        //'filterType' => GridView::FILTER_SELECT2, 
        //'filterWidgetOptions'=>[
                            ...
                            //],
        //'filterInputOptions'=>['placeholder'=>''],
        //'filter'=> FHtml::getComboArray('user_feedback', 'user_feedback', 'created_user', true, 'id', 'name'),
    //],
    ...
    //[ //name: modified_user, dbType: varchar(100), phpType: string, size: 100, allowNull: 1 
        ...
        //'value' => function($model) { return FHtml::showContent($model-> modified_user, FHtml::SHOW_LABEL, 'user_feedback', 'modified_user','varchar(100)','user-feedback'); }, 
        //'hAlign'=>'left',
        //'vAlign'=>'middle',
        //'width'=>'80px',
        //'filterType' => GridView::FILTER_SELECT2, 
        //'filterWidgetOptions'=>[
                            ...
                            //],
        //'filterInputOptions'=>['placeholder'=>''],
        //'filter'=> FHtml::getComboArray('user_feedback', 'user_feedback', 'modified_user', true, 'id', 'name'),
    //],
    [
