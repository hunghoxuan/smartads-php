...
return [
    ...
    [ //name: id, dbType: bigint(20), phpType: string, size: 20, allowNull:  
        ...
        'value' => function ($model) {
            return '<b>' . FHtml::showContent($model->id, FHtml::SHOW_NUMBER, 'tools_import', 'id', 'bigint(20)', 'tools-import') . '</b>';
        },
        'hAlign' => 'center',
        'vAlign' => 'middle',
        'width' => '50px',
    ...
    [ //name: first_row, dbType: int(11), phpType: integer, size: 11, allowNull: 1 
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->first_row, FHtml::SHOW_NUMBER, 'tools_import', 'first_row', 'int(11)', 'tools-import');
        },
        'hAlign' => 'right',
        'vAlign' => 'middle',
        'width' => '50px',
    ...
    [ //name: last_row, dbType: int(11), phpType: integer, size: 11, allowNull: 1 
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->last_row, FHtml::SHOW_NUMBER, 'tools_import', 'last_row', 'int(11)', 'tools-import');
        },
        'hAlign' => 'right',
        'vAlign' => 'middle',
        'width' => '50px',
    ...
    [ //name: columns, dbType: text, phpType: string, size: , allowNull: 1 
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->columns, '', 'tools_import', 'columns', 'text', 'tools-import');
        },
        'hAlign' => 'right',
        'vAlign' => 'middle',
        'contentOptions' => ['class' => 'col-md-1 nowrap'],
    ...
    [ //name: default_values, dbType: text, phpType: string, size: , allowNull: 1 
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->default_values, '', 'tools_import', 'default_values', 'text', 'tools-import');
        },
        'hAlign' => 'right',
        'vAlign' => 'middle',
        'contentOptions' => ['class' => 'col-md-1 nowrap'],
    ...
    [ //name: override_type, dbType: varchar(100), phpType: string, size: 100, allowNull: 1 
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->override_type, FHtml::SHOW_LABEL, 'tools_import', 'override_type', 'varchar(100)', 'tools-import');
        },
        'hAlign' => 'left',
        'vAlign' => 'middle',
        'width' => '80px',
    ...
    [ //name: type, dbType: varchar(100), phpType: string, size: 100, allowNull: 1 
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->type, FHtml::SHOW_LABEL, 'tools_import', 'type', 'varchar(100)', 'tools-import');
        },
        'hAlign' => 'left',
        'vAlign' => 'middle',
        'width' => '80px',
