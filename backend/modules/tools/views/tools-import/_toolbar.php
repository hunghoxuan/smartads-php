...
if (FHtml::isInRole('', 'action', $currentRole))
{
    ...
    FHtml::buildBulkActionsMenu('', 'tools_import', 'tools_import', 'object_type'),
FHtml::buildBulkActionsMenu('', 'tools_import', 'tools_import', 'override_type'),
FHtml::buildBulkActionsMenu('', 'tools_import', 'tools_import', 'type'),
