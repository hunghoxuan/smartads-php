...
return [
    ...
    */
    ...
    [ 
        ...
        'filter' => FHtml::getComboArray('object_content', 'object_content', 'object_id', true, 'id', 'name'),
    ],
    [ 
        'attribute' => 'object_type',
        'width' => '80px',
        'filterType' => GridView::FILTER_SELECT2, 
        'filter' => FHtml::getComboArray('object_content', 'object_content', 'object_type', true, 'id', 'name'),
    ],
    [ 
        'attribute' => 'image',
        'value' => function($model) { return FHtml::showImageThumbnail($model-> image, FHtml::config(FHtml::SETTINGS_THUMBNAIL_SIZE, 50), 'object-content'); }, 
        'width' => '50px',
    ],
    [ 
        'attribute' => 'name',
    ...
    //[ 
        ...
        //'width' => '80px',
        //'filterType' => GridView::FILTER_SELECT2, 
        //'filter' => FHtml::getComboArray('object_content', 'object_content', 'created_user', true, 'id', 'name'),
    //],
    [
