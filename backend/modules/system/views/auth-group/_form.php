            ...
            <div class="portlet light">
                ...
                <div class="portlet-title tabbable-line hidden-print">
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        <li>
                            <a href="#tab_1_2" data-toggle="tab"><?= FHtml::t('common', 'Permissions') ?></a>
                        </li>
                        <li>
                            <a href="#tab_1_3" data-toggle="tab"><?= FHtml::t('common', 'Users') ?></a>
                        </li>
                    </ul>
                </div>
                        ...
                        <div class="form-body">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane row" id="tab_1_2">
                                    <div class="col-md-12">
                                        <?= $form->field($model, 'rights')->label(false)->checkboxList(\common\components\FHtml::getApplicationRolesComboArray()); ?>
                                    </div>
                                </div>

                                <div class="tab-pane row" id="tab_1_3">
                                    <div class="col-md-12">
                                        <?= $form->field($model, 'users')->label(false)->checkboxList(\common\components\FHtml::getApplicationUsersComboArray()); ?>
