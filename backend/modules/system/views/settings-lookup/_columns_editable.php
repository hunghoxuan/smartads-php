...
return [
    ...
    [ //name: id, dbType: int(11), phpType: integer, size: 11, allowNull:  
        ...
        'value' => function ($model) {
            return '<b>' . FHtml::showContent($model->id, FHtml::SHOW_NUMBER, 'settings_lookup', 'id', 'int(11)', 'settings-lookup') . '</b>';
        },
        'hAlign' => 'center',
        'vAlign' => 'middle',
        'width' => '50px',
    ...
    [ //name: object_type, dbType: varchar(100), phpType: string, size: 100, allowNull: 1
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->object_type, FHtml::SHOW_LABEL, 'settings_lookup', 'object_type', 'varchar(100)', 'settings-lookup');
        },
        'hAlign' => 'left',
        'vAlign' => 'middle',
        'width' => '80px',
    ...
    [ //name: is_cached, dbType: tinyint(1), phpType: integer, size: 1, allowNull: 1 
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->is_cached, FHtml::SHOW_BOOLEAN, 'settings_lookup', 'is_cached', 'tinyint(1)', 'settings-lookup');
        },
        'hAlign' => 'center',
        'vAlign' => 'middle',
        'width' => '20px',
    ...
    [ //name: is_active, dbType: tinyint(4), phpType: integer, size: 4, allowNull: 1 
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->is_active, FHtml::SHOW_BOOLEAN, 'settings_lookup', 'is_active', 'tinyint(4)', 'settings-lookup');
        },
        'hAlign' => 'right',
        'vAlign' => 'middle',
        'width' => '20px',
