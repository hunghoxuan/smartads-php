...
return [
    ...
    [ //name: id, dbType: int(11), phpType: integer, size: 11, allowNull:  
        ...
        'value' => function ($model) {
            return '<b>' . FHtml::showContent($model->id, FHtml::SHOW_NUMBER, 'settings_text', 'id', 'int(11)', 'settings-text') . '</b>';
        },
        'hAlign' => 'center',
        'vAlign' => 'middle',
        'width' => '50px',
    ...
    [ //name: lang, dbType: varchar(100), phpType: string, size: 100, allowNull:  
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->lang, FHtml::SHOW_LABEL, 'settings_text', 'lang', 'varchar(100)', 'settings-text');
        },
        'hAlign' => 'left',
        'vAlign' => 'middle',
        'width' => '80px',
