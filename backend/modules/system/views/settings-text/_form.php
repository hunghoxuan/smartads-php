...
<div class="form">
    <div class="row">
        ...
        <div class="col-md-12">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active row" id="tab_1_1">
                                    <div class="col-md-12">
                                        ...
                                        <?php echo \common\widgets\formfield\FormKeyValues::widget(['field_name' => 'content', 'model' => $model, 'form' => $form, 'canEdit' => $canEdit, 'moduleKey' => $moduleKey, 'modulePath' => $modulePath]);
                                        ?>
            ...
            ?>
            <?= (FHtml::isViewAction($currentAction)) ? FHtml::showViewButtons($model, $canEdit, false, '{save}') : FHtml::showActionsButton($model, $canEdit, false, '{save}') ?>
