...
if (FHtml::isInRole('', 'action', $currentRole)) {
    $bulkActionButton = FHtml::buttonBulkActions([
        FHtml::buildBulkActionsMenu('', 'object_calendar', 'object_calendar', 'object_type'),
        FHtml::buildBulkActionsMenu('', 'object_calendar', 'object_calendar', 'status'),
        FHtml::buildBulkActionsMenu('', 'object_calendar', 'object_calendar', 'type'),
