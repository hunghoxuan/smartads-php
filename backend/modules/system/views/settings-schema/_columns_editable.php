...
return [
    ...
    [ //name: object_type, dbType: varchar(100), phpType: string, size: 100, allowNull:
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->object_type, FHtml::SHOW_LABEL, 'settings_schema', 'object_type', 'varchar(100)', 'settings-schema');
        },
        'hAlign' => 'left',
        'vAlign' => 'middle',
        'width' => '80px',
    ...
    [ //name: is_active, dbType: tinyint(1), phpType: integer, size: 1, allowNull: 1
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->is_group, FHtml::SHOW_BOOLEAN, 'settings_schema', 'is_group', 'tinyint(1)', 'settings-schema');
        },
        'hAlign' => 'center',
        'vAlign' => 'middle',
        'width' => '20px',
    ...
    [ //name: is_readonly, dbType: tinyint(1), phpType: integer, size: 1, allowNull: 1 
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->is_readonly, FHtml::SHOW_BOOLEAN, 'settings_schema', 'is_readonly', 'tinyint(1)', 'settings-schema');
        },
        'hAlign' => 'center',
        'vAlign' => 'middle',
        'width' => '20px',
    ...
    [ //name: is_active, dbType: tinyint(1), phpType: integer, size: 1, allowNull: 1
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->is_column, FHtml::SHOW_BOOLEAN, 'settings_schema', 'is_column', 'tinyint(1)', 'settings-schema');
        },
        'hAlign' => 'center',
        'vAlign' => 'middle',
        'width' => '20px',
    ...
    [ //name: is_active, dbType: tinyint(1), phpType: integer, size: 1, allowNull: 1
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->is_active, FHtml::SHOW_BOOLEAN, 'settings_schema', 'is_active', 'tinyint(1)', 'settings-schema');
        },
        'hAlign' => 'center',
        'vAlign' => 'middle',
        'width' => '20px',
