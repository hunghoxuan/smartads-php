...
return [
    ...
    [ //name: id, dbType: int(11), phpType: integer, size: 11, allowNull:  
        ...
        'value' => function ($model) {
            return '<b>' . FHtml::showContent($model->id, FHtml::SHOW_NUMBER, 'application', 'id', 'int(11)', 'application') . '</b>';
        },
        'hAlign' => 'center',
        'vAlign' => 'middle',
        'width' => '50px',
    ...
    [ //name: logo, dbType: varchar(300), phpType: string, size: 300, allowNull: 1 
        ...
        'value' => function ($model) {
            return FHtml::showImageThumbnail($model->logo, FHtml::config(FHtml::SETTINGS_THUMBNAIL_SIZE, 50), 'application');
        },
        'hAlign' => 'center',
        'vAlign' => 'middle',
        'width' => '50px',
    ...
    [ //name: lang, dbType: varchar(100), phpType: string, size: 100, allowNull: 1 
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->lang, FHtml::SHOW_LABEL, 'application', 'lang', 'varchar(100)', 'application');
        },
        'hAlign' => 'left',
        'vAlign' => 'middle',
        'width' => '80px',
    ...
    [ //name: storage_max, dbType: bigint(20), phpType: string, size: 20, allowNull: 1 
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->storage_max, FHtml::SHOW_NUMBER, 'application', 'storage_max', 'bigint(20)', 'application');
        },
        'hAlign' => 'right',
        'vAlign' => 'middle',
        'width' => '50px',
    ...
    [ //name: status, dbType: varchar(100), phpType: string, size: 100, allowNull: 1 
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->status, FHtml::SHOW_LABEL, 'application', 'status', 'varchar(100)', 'application');
        },
        'hAlign' => 'left',
        'vAlign' => 'middle',
        'width' => '80px',
    ...
    [ //name: is_active, dbType: tinyint(1), phpType: integer, size: 1, allowNull: 1
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->is_active, FHtml::SHOW_BOOLEAN, 'application', 'is_active', 'tinyint(1)', 'application');
        },
        'hAlign' => 'center',
        'vAlign' => 'middle',
        'width' => '20px',
