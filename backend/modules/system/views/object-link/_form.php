                                ...
                                <div class="tab-pane active row" id="tab_1_1">
                                    <div class="col-md-12">
                                        <?= FFormTable::widget(['model' => $model, 'form' => $form, 'columns' => 1, 'attributes' => [
                                            'object_id' => ['value' => $form->fieldNoLabel($model, 'object_id')->select(FHtml::getComboArray('object_link', 'object_link', 'object_id', true, 'id', 'name'))],
                                            'name' => ['value' => $form->fieldNoLabel($model, 'name')->textInput()],
                                            'link_url' => ['value' => $form->fieldNoLabel($model, 'link_url')->textarea(['rows' => 3])],
                                            'description' => ['value' => $form->fieldNoLabel($model, 'description')->textarea(['rows' => 3])],
                                            'label' => ['value' => $form->fieldNoLabel($model, 'label')->textInput()],
                                            'target' => ['value' => $form->fieldNoLabel($model, 'target')->select(FHtml::getComboArray('object_link', 'object_link', 'target', true, 'id', 'name'))],
                                        ]]); ?>
                                        ...
                                        <?= FFormTable::widget(['model' => $model, 'title' => FHtml::t('common', 'Group'), 'form' => $form, 'columns' => 2, 'attributes' => [
                                            'object_type' => ['value' => $form->fieldNoLabel($model, 'object_type')->select(FHtml::getComboArray('object_link', 'object_link', 'object_type', true, 'id', 'name'))],
                                            'type' => ['value' => $form->fieldNoLabel($model, 'type')->select(FHtml::getComboArray('object_link', 'object_link', 'type', true, 'id', 'name'))],
