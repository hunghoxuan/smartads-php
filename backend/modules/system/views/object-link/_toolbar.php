...
if (FHtml::isInRole('', 'action', $currentRole)) {
    $bulkActionButton = FHtml::buttonBulkActions([
        FHtml::buildBulkActionsMenu('', 'object_link', 'object_link', 'object_type'),
        FHtml::buildBulkActionsMenu('', 'object_link', 'object_link', 'type'),
        FHtml::buildBulkActionsMenu('', 'object_link', 'object_link', 'is_active'),
