                                ...
                                <div class="tab-pane active row" id="tab_1_1">
                                    <div class="col-md-12">
                                        <?= FFormTable::widget(['model' => $model, 'form' => $form, 'columns' => 1, 'attributes' => [
                                            'object_id' => ['value' => $form->fieldNoLabel($model, 'object_id')->select(FHtml::getComboArray('object_request', 'object_request', 'object_id', true, 'id', 'name'))],
                                        ...
                                        <?= FFormTable::widget(['model' => $model, 'title' => FHtml::t('common', 'Group'), 'form' => $form, 'columns' => 2, 'attributes' => [
                                            'object_type' => ['value' => $form->fieldNoLabel($model, 'object_type')->select(FHtml::getComboArray('object_request', 'object_request', 'object_type', true, 'id', 'name'))],
                                            'type' => ['value' => $form->fieldNoLabel($model, 'type')->select(FHtml::getComboArray('object_request', 'object_request', 'type', true, 'id', 'name'))],
                                        ...
                                        <?= FFormTable::widget(['model' => $model, 'title' => FHtml::t('common', 'user'), 'form' => $form, 'columns' => 2, 'attributes' => [
                                            'user_id' => ['value' => $form->fieldNoLabel($model, 'user_id')->select(FHtml::getComboArray('@app_user', 'app_user', 'user_id', true, 'id', 'name'))],
                                            'user_type' => ['value' => $form->fieldNoLabel($model, 'user_type')->select(FHtml::getComboArray('object_request', 'object_request', 'user_type', true, 'id', 'name'))],
                                            'user_role' => ['value' => $form->fieldNoLabel($model, 'user_role')->select(FHtml::getComboArray('object_request', 'object_request', 'user_role', true, 'id', 'name'))],
                                        ]]); ?>
