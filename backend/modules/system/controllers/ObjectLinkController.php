...
use backend\modules\system\models\ObjectLinkSearch;
...
/**
 * ObjectLinkController implements the CRUD actions for ObjectLink model.
 */
class ObjectLinkController extends AdminController
{
    protected $moduleName = 'ObjectLink';
    protected $moduleTitle = 'Object Link';
    protected $moduleKey = 'object_link';
    protected $object_type = 'object_link';
    ...
    /**
     * Lists all ObjectLink models.
     * @return mixed
     */
    public function actionIndex()
    {
        /* @var $searchModel ObjectLinkSearch */
        $searchModel = ObjectLink::createNew();
        ...
        if (Yii::$app->request->post('hasEditable')) {
            ...
            $model = ObjectLink::findOne($Id);

            $out = Json::encode(['output' => '', 'message' => '']);

            $post = [];
            $posted = current($_POST['ObjectLink']);
            $post['ObjectLink'] = $posted;
    ...
    /**
     * Displays a single ObjectLink model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new ObjectLink model.
    ...
    /**
     * Updates an existing ObjectLink model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing ObjectLink model.
     * For ajax request will return json object
    ...
    /**
     * Delete multiple existing ObjectLink model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Finds the ObjectLink model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return ObjectLink the loaded model
