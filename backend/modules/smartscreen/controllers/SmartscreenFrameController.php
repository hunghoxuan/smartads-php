...
use backend\modules\smartscreen\models\SmartscreenFrameSearch;
...
/**
 * SmartscreenFrameController implements the CRUD actions for SmartscreenFrame model.
 */
class SmartscreenFrameController extends AdminController
{
    protected $moduleName = 'SmartscreenFrame';
    protected $moduleTitle = 'Smartscreen Frame';
    protected $moduleKey = 'smartscreen_frame';
    protected $object_type = 'smartscreen_frame';
    ...
    /**
     * Lists all SmartscreenFrame models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = SmartscreenFrameSearch::createNew();
        ...
        if (Yii::$app->request->post('hasEditable')) {
            ...
            $model = SmartscreenFrame::findOne($Id);

            $out = Json::encode(['output' => '', 'message' => '']);

            $post = [];
            $posted = current($_POST['SmartscreenFrame']);
            $post['SmartscreenFrame'] = $posted;
    ...
    /**
     * Displays a single SmartscreenFrame model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new SmartscreenFrame model.
    ...
    public function actionCreate($type = false)
    {
        ...
        if ($request->isAjax) {
            ...
            if ($model->load($request->post())) {
                ...
                $backgroundColor = $_REQUEST['SmartscreenFrame']['backgroundColor'];
    ...
    /**
     * Updates an existing SmartscreenFrame model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing SmartscreenFrame model.
     * For ajax request will return json object
    ...
    /**
     * Delete multiple existing SmartscreenFrame model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Finds the SmartscreenFrame model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return SmartscreenFrame the loaded model
