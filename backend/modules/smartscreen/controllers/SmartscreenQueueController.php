...
use backend\modules\smartscreen\models\SmartscreenQueueSearch;
...
/**
 * SmartscreenQueueController implements the CRUD actions for SmartscreenQueue model.
 */
class SmartscreenQueueController extends AdminController
{
    protected $moduleName = 'SmartscreenQueue';
    protected $moduleTitle = 'Smartscreen Queue';
    protected $moduleKey = 'smartscreen_queue';
    protected $object_type = 'smartscreen_queue';
    ...
    /**
     * Lists all SmartscreenQueue models.
     * @return mixed
     */
    public function actionIndex()
    {
        /* @var $searchModel SmartscreenQueueSearch */
        $searchModel = SmartscreenQueueSearch::createNew();
        ...
        if (Yii::$app->request->post('hasEditable')) {
            ...
            $model = SmartscreenQueue::findOne($Id);

            $out = Json::encode(['output' => '', 'message' => '']);

            $post = [];
            $posted = current($_POST['SmartscreenQueue']);
            $post['SmartscreenQueue'] = $posted;
    ...
    /**
     * Displays a single SmartscreenQueue model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new SmartscreenQueue model.
    ...
    /**
     * Updates an existing SmartscreenQueue model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing SmartscreenQueue model.
     * For ajax request will return json object
    ...
    /**
     * Delete multiple existing SmartscreenQueue model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Finds the SmartscreenQueue model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return SmartscreenQueue the loaded model
    ...
    /**
     * Create the SmartscreenQueue model.
     * @return SmartscreenQueue the loaded model
     */
