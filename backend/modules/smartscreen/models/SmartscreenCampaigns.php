...
class SmartscreenCampaigns extends SmartscreenSchedules
{
    public function search($params, $andWhere = '')
    {
        ...
        $is_active = !empty($this->is_active) ? $this->is_active : true;

        $query = static::getQuery($channel_id, $device_id, $this->date, $this->date_end, $is_active);
    ...
    public static function getQuery($channel_id, $device_id,  $date = null, $date_end = null, $is_active = true)
    {
        if (empty($date_end))
            $date_end = $date;
        ...
        // $query = $query->andWhere(SmartscreenSchedules::FIELD_STATUS . "= $is_active");
