 ...
 */
class SmartscreenFileAction extends BaseApiAction
{
    ...
    public function run()
    {
        ...
        if (!empty($this->objectid)) {
            ...
            $object = SmartscreenFileAPI::findOne($this->objectid);
            ...
            $list = SmartscreenFileAPI::getDataProvider(Fhtml::mergeRequestParams(['name' => '%'.$this->keyword], $this->paramsArray), $this->orderby, $this->limit, $this->page, false);
