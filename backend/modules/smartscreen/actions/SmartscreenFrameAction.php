 ...
 */
class SmartscreenFrameAction extends BaseApiAction
{
    ...
    public function run()
    {
        ...
        if (!empty($this->objectid)) {
            ...
            $object = SmartscreenFrameAPI::findOne($this->objectid);
            ...
            $list = SmartscreenFrameAPI::getDataProvider(Fhtml::mergeRequestParams(['name' => '%' . $this->keyword], $this->paramsArray), $this->orderby, $this->limit, $this->page, false);
