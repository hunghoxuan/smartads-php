...
if (FHtml::isInRole('', 'action', $currentRole))
{
    ...
    FHtml::buildBulkActionsMenu('', 'smartscreen_content', 'smartscreen_content', 'type'),
FHtml::buildBulkActionsMenu('', 'smartscreen_content', 'smartscreen_content', 'is_active'),
