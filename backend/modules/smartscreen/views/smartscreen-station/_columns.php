...
//    ],
    ...
    [
        ...
        'content' => function($model) {
            ...
            $result .= "<a style='float:left; margin: 2px' href='$url' title='Manage Schedules' target='_blank' data-pjax='0' class='label label-warning label-xs'> <span class=\"glyphicon glyphicon-th-list\"></span> </a>";
