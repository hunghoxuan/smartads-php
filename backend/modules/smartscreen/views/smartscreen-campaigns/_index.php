...
<div class="smartscreen-campaigns-index">
    ...
    <div class="<?= $this->params['portletStyle'] ?>">
        ...
        <div class="portlet-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    <?php echo \common\widgets\FFormTable::widget(['hide_field' => false,
                        'type'                   => \kartik\form\ActiveForm::TYPE_VERTICAL,
                        'model' => $model, 'form' => $form, 'columns' => 4, 'attributes' => [
                            'channel_id' => ['value' => $form->fieldNoLabel($model, 'channel_id')->select($list_channels), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                            'device_id' => ['value' => $form->fieldNoLabel($model, 'device_id')->selectCustomRenderer(SmartscreenStation::findAll(), function($item, $id) { $selected = $item->id == $id ? 'selected' : ''; return "<option parent='$item->channel_id' value='$item->id' $selected>$item->name</option>"; }), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
