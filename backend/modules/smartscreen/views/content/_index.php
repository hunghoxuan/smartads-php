...
<div id="slides" class="slides">
    <?php
        ...
        foreach ($slides as $slide) {
            ...
            if ($command == 'marquee') {
                ...
                $control =  "<video onclick=\"pauseSlide()\" width=\"100%\" height=\"100%\" preload=\"auto\" poster=\"$blank_img\" loop><source src=\"$url#t=0.5\" type=\"video/$ext\"></video>";
    ...
    <div id="slide_video_time" class="timer" style=""></div>
...
<script>
    ...
    <?php foreach ($controls as $i=>$control) {
