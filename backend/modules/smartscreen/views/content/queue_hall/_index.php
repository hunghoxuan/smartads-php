...
$models_limit = isset($limit) ? $limit : 8;
...
<table class="table">
    <thead>
        <tr>
            ...
            <th class="col-xs-6"><?= FHtml::t('common', 'Customer') ?></th>
            <th class="col-xs-4 text-center"><?= FHtml::t('common', 'Age') ?></th>
        </tr>
    </thead>
    <tbody>
    <?php $i = 0;
    for ($i = 0; $i < $models_limit; $i++) {
        ...
        <tr>
            ...
            <td class="text-center"><?= !isset($model) ? $null_value : FHtml::getFieldValue($model, 'description') ?></td>
        </tr>
    <?php }
        ?>
