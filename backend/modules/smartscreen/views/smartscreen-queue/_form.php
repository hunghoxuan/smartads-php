                                ...
                                <div class="tab-pane active row" id="tab_1_1">
                                    <div class="col-md-12">
                                        <?= FFormTable::widget(['model' => $model, 'form' => $form, 'columns' => 1, 'attributes' => [
                                            ...
                                            'counter' => ['value' => $form->fieldNoLabel($model, 'counter')->textInput()],

                                            'service_id' => ['value' => $form->fieldNoLabel($model, 'service_id')->lookup('qms_services', [], ['service' => 'name'])],
                                            //'service_id' => ['value' => $form->fieldNoLabel($model, 'service_id')->selectInput()],
                                            'service' => ['value' => $form->fieldNoLabel($model, 'service')->textInput()],
                                            'note' => ['value' => $form->fieldNoLabel($model, 'note')->textarea()],
                                            'device_id' => ['value' => $form->fieldNoLabel($model, 'device_id')->select(\backend\modules\smartscreen\models\SmartscreenStation::findAllForCombo())],
                                            'status' => ['value' => $form->fieldNoLabel($model, 'status')->select(FHtml::getComboArray('smartscreen_queue', 'smartscreen_queue', 'status', true, 'id', 'name'))],
