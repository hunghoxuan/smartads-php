    ...
    [
        ...
        'value'=>function ($model, $key, $index, $column) {
            ...
            if (is_numeric($model->channel_id)) {
                ...
                return "<b>" . FHtml::t('Channels') . ": $name</b>";
            } else {
        ...
        'value'=>function ($model, $key, $index, $column) {
            if ($model->device_id == FHtml::NULL_VALUE)
                ...
                foreach ($devices as $device_id) {
                    ...
                    $arr[] = is_object($item) ? "$item->name <small style='color:darkgrey'>$item->description</small> <br/>" . Smartscreen::showDeviceLastUpdate($item, $device_id, false) : $item;
                }
                $devices = $arr;
                if (empty($devices))
