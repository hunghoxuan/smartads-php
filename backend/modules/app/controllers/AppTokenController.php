...
use backend\modules\app\models\AppTokenSearch;
...
/**
 * AppTokenController implements the CRUD actions for AppToken model.
 */
class AppTokenController extends AdminController
{
    protected $moduleName = 'AppToken';
    protected $moduleTitle = 'App Token';
    protected $moduleKey = 'app_token';
    protected $object_type = 'app_token';
    ...
    /**
     * Lists all AppToken models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new AppTokenSearch();
        ...
        if (Yii::$app->request->post('hasEditable')) {
            ...
            $model = AppToken::findOne($Id);

            $out = Json::encode(['output' => '', 'message' => '']);

            $post = [];
            $posted = current($_POST['AppToken']);
            $post['AppToken'] = $posted;
    ...
    /**
     * Displays a single AppToken model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Updates an existing AppToken model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing AppToken model.
     * For ajax request will return json object
    ...
    /**
     * Delete multiple existing AppToken model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Finds the AppToken model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return AppToken the loaded model
