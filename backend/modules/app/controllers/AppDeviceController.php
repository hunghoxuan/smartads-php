...
use backend\modules\app\models\AppDeviceSearch;
...
/**
 * AppDeviceController implements the CRUD actions for AppDevice model.
 */
class AppDeviceController extends AdminController
{
    protected $moduleName = 'AppDevice';
    protected $moduleTitle = 'App Device';
    protected $moduleKey = 'app_device';
    protected $object_type = 'app_device';
    ...
    /**
     * Lists all AppDevice models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new AppDeviceSearch();
        ...
        if (Yii::$app->request->post('hasEditable')) {
            ...
            $model = AppDevice::findOne($Id);

            $out = Json::encode(['output' => '', 'message' => '']);

            $post = [];
            $posted = current($_POST['AppDevice']);
            $post['AppDevice'] = $posted;
    ...
    /**
     * Displays a single AppDevice model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Updates an existing AppDevice model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing AppDevice model.
     * For ajax request will return json object
    ...
    /**
     * Delete multiple existing AppDevice model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Finds the AppDevice model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return AppDevice the loaded model
