                                    ...
                                    <div class="tab-pane active row" id="tab_1_1">
                                        <div class="col-md-12">
                                            <?= FFormTable::widget(['model' => $model, 'form' => $form, 'columns' => 2, 'attributes' => [
                                                'file_name' => ['value' => $form->fieldNoLabel($model, 'file_name')->selectMany(FHtml::getComboArray('app_file', 'app_file', 'file_name', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                                                'file_size' => ['value' => $form->fieldNoLabel($model, 'file_size')->numeric(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                                            ]]); ?>
                                            <?php /*
;
                                            */ ?>
