...
return [
    ...
    [ //name: id, dbType: int(11), phpType: integer, size: 11, allowNull:  
        ...
        'value' => function ($model) {
            return '<b>' . FHtml::showContent($model->id, FHtml::SHOW_NUMBER, 'user', 'id', 'int(11)', 'user') . '</b>';
        },
        'hAlign' => 'center',
        'vAlign' => 'middle',
        'width' => '50px',
    ...
    [ //name: image, dbType: varchar(300), phpType: string, size: 300, allowNull: 1
        ...
        'value' => function ($model) {
            return FHtml::showImageThumbnail($model->image, FHtml::config(FHtml::SETTINGS_THUMBNAIL_SIZE, 50), 'user');
        },
        'hAlign' => 'center',
        'vAlign' => 'middle',
        'width' => '50px',
    ...
    [ //name: type, dbType: varchar(100), phpType: string, size: 100, allowNull: 1 
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->type, FHtml::SHOW_LABEL, 'user', 'type', 'varchar(100)', 'user');
        },
        'hAlign' => 'left',
        'vAlign' => 'middle',
        'width' => '80px',
    ...
    [ //name: status, dbType: smallint(6), phpType: integer, size: 6, allowNull:  
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->status, FHtml::SHOW_LABEL, 'user', 'status', 'smallint(6)', 'user');
        },
        'hAlign' => 'left',
        'vAlign' => 'middle',
        'filterType' => GridView::FILTER_SELECT2,
