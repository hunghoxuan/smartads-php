...
if (FHtml::isInRole('', 'action', $currentRole)) {
    $bulkActionButton = FHtml::buttonBulkActions([
        FHtml::buildBulkActionsMenu('', 'app_membership', 'app_membership', 'type'),
        FHtml::buildBulkActionsMenu('', 'app_membership', 'app_membership', 'is_active'),
