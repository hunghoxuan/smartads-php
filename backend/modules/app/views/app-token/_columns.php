...
/*
    ...
    [ //name: id, dbType: int(11), phpType: integer, size: 11, allowNull:  
        ...
        'value' => function($model) { return '<b>' . FHtml::showContent($model-> id, FHtml::SHOW_NUMBER, 'app_token', 'id','int(11)','app-token') . '</b>' ; }, 
        'hAlign'=>'center',
        'vAlign'=>'middle',
        'width'=>'50px',
    ],
    [ //name: user_id, dbType: int(11), phpType: integer, size: 11, allowNull:  
        ...
        'value' => function($model) { return FHtml::showContent($model->user_id, FHtml::SHOW_LABEL, 'app_token', 'user_id','int(11)','app-token'); }, 
        'hAlign'=>'left',
        'vAlign'=>'middle',
    ...
    [ //name: is_expired, dbType: tinyint(1), phpType: integer, size: 1, allowNull: 1 
        ...
        'value' => function($model) { return FHtml::showContent($model-> is_expired, FHtml::SHOW_BOOLEAN, 'app_token', 'is_expired','tinyint(1)','app-token'); }, 
        'hAlign'=>'center',
        'vAlign'=>'middle',
        'width'=>'20px',
    ],
