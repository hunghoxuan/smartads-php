...
/*
    ...
    [ //name: id, dbType: int(11), phpType: integer, size: 11, allowNull:
        ...
        'value' => function($model) { return '<b>' . FHtml::showContent($model-> id, FHtml::SHOW_NUMBER, 'app_device', 'id','int(11)','app-device') . '</b>' ; },
        'hAlign'=>'center',
        'vAlign'=>'middle',
        'width'=>'50px',
    ],
    [ //name: user_id, dbType: int(11), phpType: integer, size: 11, allowNull: 1
        ...
        'value' => function($model) { return FHtml::showContent($model->user_id, FHtml::SHOW_LOOKUP, '@app_user', 'user_id','int(11)','app-device'); },
        'hAlign'=>'left',
        'vAlign'=>'middle',
    ...
    [ //name: gcm_id, dbType: varchar(255), phpType: string, size: 255, allowNull:  
        ...
        'value' => function($model) { return FHtml::showContent($model-> gcm_id, FHtml::SHOW_LABEL, 'app_device', 'gcm_id','varchar(255)','app-device'); }, 
        'hAlign'=>'left',
        'vAlign'=>'middle',
        'width'=>'100px',
        'filterType' => GridView::FILTER_SELECT2, 
        ...
        'filterInputOptions'=>['placeholder'=>''],
        'filter'=> FHtml::getComboArray('app_device', 'app_device', 'gcm_id', true, 'id', 'name'),
    ],
