...
return [
    ...
    [ //name: id, dbType: bigint(20), phpType: string, size: 20, allowNull:  
        ...
        'value' => function ($model) {
            return '<b>' . FHtml::showContent($model->id, FHtml::SHOW_NUMBER, 'app_user_transaction', 'id', 'bigint(20)', 'app-user-transaction') . '</b>';
        },
        'hAlign' => 'center',
        'vAlign' => 'middle',
        'width' => '50px',
    ...
    [ //name: transaction_id, dbType: varchar(255), phpType: string, size: 255, allowNull:  
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->transaction_id, FHtml::SHOW_LABEL, 'app_user_transaction', 'transaction_id', 'varchar(255)', 'app-user-transaction');
        },
        'hAlign' => 'left',
        'vAlign' => 'middle',
        'width' => '100px',
    ...
    [ //name: user_id, dbType: varchar(100), phpType: string, size: 100, allowNull:  
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->user_id, FHtml::SHOW_LABEL, 'app_user_transaction', 'user_id', 'varchar(100)', 'app-user-transaction');
        },
        'hAlign' => 'left',
        'vAlign' => 'middle',
        'width' => '80px',
    ...
    [ //name: receiver_user_id, dbType: varchar(100), phpType: string, size: 100, allowNull:  
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->receiver_user_id, FHtml::SHOW_LOOKUP, '@user', 'receiver_user_id', 'varchar(100)', 'app-user-transaction');
        },
        'hAlign' => 'left',
        'vAlign' => 'middle',
        'width' => '80px',
        ...
        'filterInputOptions' => ['placeholder' => ''],
        'filter' => FHtml::getComboArray('@user', 'user', 'receiver_user_id', true, 'id', 'name'),
    ],
    [ //name: object_id, dbType: varchar(100), phpType: string, size: 100, allowNull: 1 
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->object_id, FHtml::SHOW_LABEL, 'app_user_transaction', 'object_id', 'varchar(100)', 'app-user-transaction');
        },
        'hAlign' => 'left',
        'vAlign' => 'middle',
        'width' => '80px',
    ...
    [ //name: object_type, dbType: varchar(100), phpType: string, size: 100, allowNull: 1 
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->object_type, FHtml::SHOW_LABEL, 'app_user_transaction', 'object_type', 'varchar(100)', 'app-user-transaction');
        },
        'hAlign' => 'left',
        'vAlign' => 'middle',
        'width' => '80px',
    ...
    [ //name: amount, dbType: decimal(20,2), phpType: string, size: 20, allowNull:  
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->amount, FHtml::SHOW_DECIMAL, 'app_user_transaction', 'amount', 'decimal(20,2)', 'app-user-transaction');
        },
        'hAlign' => 'right',
        'vAlign' => 'middle',
        'width' => '50px',
    ...
    [ //name: type, dbType: varchar(100), phpType: string, size: 100, allowNull: 1 
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->type, FHtml::SHOW_LABEL, 'app_user_transaction', 'type', 'varchar(100)', 'app-user-transaction');
        },
        'hAlign' => 'left',
        'vAlign' => 'middle',
        'width' => '80px',
    ...
    [ //name: status, dbType: varchar(100), phpType: string, size: 100, allowNull:  
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->status, FHtml::SHOW_LABEL, 'app_user_transaction', 'status', 'varchar(100)', 'app-user-transaction');
        },
        'hAlign' => 'left',
        'vAlign' => 'middle',
        'width' => '80px',
