                                    ...
                                    <div class="tab-pane active row" id="tab_1_1">
                                        <div class="col-md-12">
                                            <?= FFormTable::widget(['model' => $model, 'form' => $form, 'columns' => 1, 'attributes' => [
                                                ...
                                                'action' => ['value' => $form->fieldNoLabel($model, 'action')->select(FHtml::getComboArray('app_log', 'app_log', 'action', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                                                'note' => ['value' => $form->fieldNoLabel($model, 'note')->html(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                                                'tracking_time' => ['value' => $form->fieldNoLabel($model, 'tracking_time')->dateInput(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                                            ]]); ?>
