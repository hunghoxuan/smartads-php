...
return [
    ...
    [ //name: sent_type, dbType: varchar(100), phpType: string, size: 100, allowNull: 1 
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->sent_type, FHtml::SHOW_LABEL, 'app_notification', 'sent_type', 'varchar(100)', 'app-notification');
        },
        'hAlign' => 'left',
        'vAlign' => 'middle',
        'width' => '80px',
    ...
    [ //name: receiver_count, dbType: bigint(20), phpType: string, size: 20, allowNull: 1
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->receiver_count, FHtml::SHOW_NUMBER, 'app_notification', 'receiver_count', 'bigint(20)', 'app-notification');
        },
        'hAlign' => 'right',
        'vAlign' => 'middle',
        'width' => '50px',
