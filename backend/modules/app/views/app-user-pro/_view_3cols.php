        ...
        <div class="profile-sidebar col-md-3 hidden-print">
            ...
            <div class="portlet light">
                <div class="row list-separated profile-stat">
                    <div class="col-md-4 col-sm-4 col-xs-6"><?= FHtml::showField('Rate Count', $model->rate_count, FHtml::SHOW_NUMBER) ?> </div>
                </div>
                <div>
                    <div class="row list-separated profile-stat">
                        <div class="col-md-6">
        ...
        <div class="col-md-9">
            ...
            <?php } else { ?>
                <p class="hidden-print">
                    ...
                    <?php if ($canEdit) {
                        echo Html::a('<i class="fa fa-pencil"></i> ' .  FHtml::t('common', 'Update'), ['update', 'id' => $model->user_id], ['class' => 'btn btn-warning']);
                    } ?>
                    <?php if ($canDelete) {
                        echo Html::a('<i class="fa fa-trash"></i> ' .  FHtml::t('common', 'Delete'), ['delete', 'id' => $model->user_id], [
