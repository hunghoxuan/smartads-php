...
return [
    ...
    [ //name: user_id, dbType: int(11), phpType: integer, size: 11, allowNull:  
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->user_id, FHtml::SHOW_LABEL, 'app_user_pro', 'user_id', 'int(11)', 'app-user-pro');
        },
        'hAlign' => 'left',
        'vAlign' => 'middle',
    ...
    [ //name: rate, dbType: float(3,1), phpType: double, size: 3, allowNull: 1 
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->rate, '', 'app_user_pro', 'rate', 'float(3,1)', 'app-user-pro');
        },
        'hAlign' => 'right',
        'vAlign' => 'middle',
        'contentOptions' => ['class' => 'col-md-1 nowrap'],
    ...
    [ //name: rate_count, dbType: int(11), phpType: integer, size: 11, allowNull: 1 
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->rate_count, FHtml::SHOW_NUMBER, 'app_user_pro', 'rate_count', 'int(11)', 'app-user-pro');
        },
        'hAlign' => 'right',
        'vAlign' => 'middle',
        'width' => '50px',
    ...
    [ //name: is_active, dbType: tinyint(1), phpType: integer, size: 1, allowNull:  
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->is_active, FHtml::SHOW_BOOLEAN, 'app_user_pro', 'is_active', 'tinyint(1)', 'app-user-pro');
        },
        'hAlign' => 'center',
        'vAlign' => 'middle',
        'width' => '20px',
