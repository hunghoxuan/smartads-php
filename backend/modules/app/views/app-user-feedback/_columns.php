...
return [
    ...
    [ //name: id, dbType: int(11), phpType: integer, size: 11, allowNull:  
        ...
        'value' => function ($model) {
            return '<b>' . FHtml::showContent($model->id, FHtml::SHOW_NUMBER, 'app_user_feedback', 'id', 'int(11)', 'app-user-feedback') . '</b>';
        },
        'hAlign' => 'center',
        'vAlign' => 'middle',
        'width' => '50px',
    ...
    [ //name: user_id, dbType: varchar(100), phpType: string, size: 100, allowNull:  
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->user_id, FHtml::SHOW_LOOKUP, '@user', 'user_id', 'varchar(100)', 'app-user-feedback');
        },
        'hAlign' => 'left',
        'vAlign' => 'middle',
        'width' => '80px',
    ...
    [ //name: object_id, dbType: varchar(100), phpType: string, size: 100, allowNull: 1 
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->object_id, FHtml::SHOW_LABEL, 'app_user_feedback', 'object_id', 'varchar(100)', 'app-user-feedback');
        },
        'hAlign' => 'left',
        'vAlign' => 'middle',
        'width' => '80px',
    ...
    [ //name: object_type, dbType: varchar(100), phpType: string, size: 100, allowNull: 1 
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->object_type, FHtml::SHOW_LABEL, 'app_user_feedback', 'object_type', 'varchar(100)', 'app-user-feedback');
        },
        'hAlign' => 'left',
        'vAlign' => 'middle',
        'width' => '80px',
    ...
    [ //name: response, dbType: text, phpType: string, size: , allowNull: 1 
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->response, '', 'app_user_feedback', 'response', 'text', 'app-user-feedback');
        },
        'hAlign' => 'right',
        'vAlign' => 'middle',
    ...
    [ //name: type, dbType: varchar(100), phpType: string, size: 100, allowNull: 1 
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->type, FHtml::SHOW_LABEL, 'app_user_feedback', 'type', 'varchar(100)', 'app-user-feedback');
        },
        'hAlign' => 'left',
        'vAlign' => 'middle',
        'width' => '80px',
    ...
    [ //name: status, dbType: varchar(100), phpType: string, size: 100, allowNull: 1 
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->status, FHtml::SHOW_LABEL, 'app_user_feedback', 'status', 'varchar(100)', 'app-user-feedback');
        },
        'hAlign' => 'left',
        'vAlign' => 'middle',
        'width' => '80px',
