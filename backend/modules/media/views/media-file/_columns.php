...
return [
    ...
    [ //name: id, dbType: bigint(20), phpType: string, size: 20, allowNull:  
        ...
        'value' => function($model) { return '<b>' . FHtml::showContent($model-> id, FHtml::SHOW_NUMBER, 'media_file', 'id','bigint(20)','media-file') . '</b>' ; }, 
        'hAlign'=>'center',
        'vAlign'=>'middle',
        'width'=>'50px',
    ],
    ...
    [ //name: image, dbType: varchar(300), phpType: string, size: 300, allowNull: 1 
        ...
        'value' => function($model) { return FHtml::showImageThumbnail($model-> image, FHtml::config(FHtml::SETTINGS_THUMBNAIL_SIZE, 50), 'media-file'); }, 
        'hAlign'=>'center',
        'vAlign'=>'middle',
        'width'=>'50px',
        'editableOptions'=>[                       
    ...
    [ //name: is_active, dbType: tinyint(1), phpType: integer, size: 1, allowNull: 1 
        ...
        'value' => function($model) { return FHtml::showContent($model-> is_active, FHtml::SHOW_BOOLEAN, 'media_file', 'is_active','tinyint(1)','media-file'); }, 
        'hAlign'=>'center',
        'vAlign'=>'middle',
        'width'=>'20px',
    ],
