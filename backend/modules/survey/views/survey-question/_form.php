                                    ...
                                    <div class="tab-pane active row" id="tab_1_1">
                                        <div class="col-md-12">
                                            <?= FFormTable::widget(['model' => $model, 'form' => $form, 'columns' => 1, 'attributes' => [
                                                ...
                                                'image' => ['value' => $form->fieldNoLabel($model, 'image')->file(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],

                                                'hint' => ['value' => $form->fieldNoLabel($model, 'hint')->textarea(['rows' => 3]), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],

                                                'type' => ['value' => $form->fieldNoLabel($model, 'type')->select(FHtml::getComboArray('survey_question', 'survey_question', 'type', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                                                'answers' => ['value' => $form->fieldNoLabel($model, 'answers')->multipleInput(['key', 'content']), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],

                                                'allow_comment' => ['value' => $form->fieldNoLabel($model, 'allow_comment')->checkbox(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
