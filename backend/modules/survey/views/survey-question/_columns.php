...
*/
    ...
    [ 
        ...
        'filter' => FHtml::getComboArray('survey_question', 'survey_question', 'type', true, 'id', 'name'),
    ],
    //[ 
    ...
    //[ 
        ...
        //'width' => '80px',
        //'filterType' => GridView::FILTER_SELECT2, 
        //'filter' => FHtml::getComboArray('survey_question', 'survey_question', 'created_user', true, 'id', 'name'),
    //],
    [
