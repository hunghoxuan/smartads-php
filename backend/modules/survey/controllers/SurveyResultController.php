...
use backend\modules\survey\models\SurveyResultSearch;
 ...
 */
class SurveyResultController extends AdminController
{
    protected $moduleName = 'SurveyResult';
    protected $moduleTitle = 'Survey Result';
    protected $moduleKey = 'survey_result';
    protected $object_type = 'survey_result';
    ...
    /**
     * Lists all SurveyResult models.
     * @return mixed
     */
    public function actionIndex()
    {
        /* @var $searchModel SurveyResultSearch */
        $searchModel = SurveyResultSearch::createNew();
        ...
        if (Yii::$app->request->post('hasEditable')) {
            ...
            $model = SurveyResult::findOne($Id);

            $out = Json::encode(['output' => '', 'message' => '']);

            $post = [];
            $posted = current($_POST['SurveyResult']);
            $post['SurveyResult'] = $posted;
    ...
    /**
     * Displays a single SurveyResult model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new SurveyResult model.
    ...
    /**
     * Updates an existing SurveyResult model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing SurveyResult model.
     * For ajax request will return json object
    ...
    /**
     * Delete multiple existing SurveyResult model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Finds the SurveyResult model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return SurveyResult the loaded model
