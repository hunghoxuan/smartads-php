        ...
        <div class="profile-sidebar col-md-3">
            ...
            <div class="portlet light">
                <div class="row list-separated profile-stat">
                    <div class="col-md-4 col-sm-4 col-xs-6"><?= FHtml::showField('Views', $model->count_views, FHtml::SHOW_NUMBER) ?> </div>
                    <div class="col-md-4 col-sm-4 col-xs-6"><?= FHtml::showField('Comments', $model->count_comments, FHtml::SHOW_NUMBER) ?> </div>
                    <div class="col-md-4 col-sm-4 col-xs-6"><?= FHtml::showField('Likes', $model->count_likes, FHtml::SHOW_NUMBER) ?> </div>
                    <div class="col-md-4 col-sm-4 col-xs-6"><?= FHtml::showField('Rates', $model->count_rates, FHtml::SHOW_NUMBER) ?> </div>
                </div>
                <div>
                    <div class="row list-separated profile-stat">
                        <div class="col-md-6">
