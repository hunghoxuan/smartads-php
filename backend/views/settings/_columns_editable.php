...
return [
    ...
    [ //name: metaKey, dbType: varchar(255), phpType: string, size: 255, allowNull:
        ...
        'value' => function ($model) {
            return FHtml::t('common', \yii\helpers\BaseInflector::camel2words($model->group));
        },
    ...
    [ //name: metaKey, dbType: varchar(255), phpType: string, size: 255, allowNull:
        ...
        'value' => function ($model) {
            return '' . FHtml::t('common', \yii\helpers\BaseInflector::camel2words($model->metaKey));
        },
        'hAlign' => 'left',
        'vAlign' => 'middle',
    ...
    [ //name: metaValue, dbType: varchar(255), phpType: string, size: 255, allowNull: 1 
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->metaValue, $model->editor, '@' . $model->lookup, 'lookup', 'varchar(100)', 'settings');
        },
        'hAlign' => 'left',
        'vAlign' => 'middle',
