...
//    ],
    ...
    [ //name: metaKey, dbType: varchar(255), phpType: string, size: 255, allowNull:
        ...
        'format'=>'raw',
        'attribute'=>'group',
        'value' => function($model) { return '<div style="padding:5px; font-weight: bold; border-left:2px solid lightgrey; background-color: #f0f1fe; font-decoration:uppercase">' . FHtml::t('common', \yii\helpers\BaseInflector::camel2words($model->group)) . '</div>'; },
        'visible' => true,
        'hAlign'=>'left',
        'vAlign'=>'middle',
    ...
    [ //name: metaKey, dbType: varchar(255), phpType: string, size: 255, allowNull:
        ...
        'attribute'=>'metaKey',
        'edit_type' => 'default',
        'value' => function($model) { return '' . FHtml::t('common', \yii\helpers\BaseInflector::camel2words($model->metaKey)) . '<br/>' . "<div style='font-size:80%;color:grey'>$model->metaKey</div>"; },
        'hAlign'=>'left',
        'vAlign'=>'middle',
    ...
    [ //name: metaValue, dbType: varchar(255), phpType: string, size: 255, allowNull: 1
        ...
        'format'=>'default',
        'attribute'=>'metaValue',
        'value' => function($model) { return FHtml::showModelFieldEditorInput($model, 'metaValue', $model->editor, $model->lookup, 'crud-datatableSettings-pjax');
            },
