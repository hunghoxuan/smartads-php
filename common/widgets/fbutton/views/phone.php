...
<div class="pull-right">
    <a class="fancybox" href="<?= $btn_url ?>" style="right: 100px; bottom: 0px;" target="_blank">
        <div class="coccoc-alo-phone coccoc-alo-green coccoc-alo-show" id="coccoc-alo-phoneIcon">
            <div class="coccoc-alo-ph-circle"></div>
            <div class="coccoc-alo-ph-circle-fill"></div>
            <div class="coccoc-alo-ph-img-circle" style="background: rgba(30, 30, 30, 0.1) url(<?= \common\components\FHtml::getImageUrl('social/skype.png','www') ?>) no-repeat center center !important;"></div>
        </div>
    </a>
</div>
...
<style>
    ...
    .coccoc-alo-phone.coccoc-alo-green .coccoc-alo-ph-circle-fill {
        background-color: rgb(113, 182, 225);
