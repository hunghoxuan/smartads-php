            ...
            <td align="center" bgcolor="#eff3f8">
                ...
                <table border="0" cellspacing="0" cellpadding="0" class="table_width_100" width="100%"
                    ...
                    <span style="font-family: Arial, Helvetica, sans-serif; font-size: 17px; color: #4db3a4;">
                        Dear<?= $user->name ?>, your registration is completed!
                    </span></font>
                                        </div>
                                        <!-- padding -->
                                ...
                                <tr>
                                    <td align="center">
                                        <div style="line-height:24px;">
                                            <a href="<?= $confirm_url ?>" target="_blank" style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 13px;">
                                                <font face="Arial, Helvetica, sans-seri; font-size: 13px;" size="3" color="#596167">CONFIRM REGISTRATION</font>
                                            </a>
                                        </div>
                                        <!-- padding -->
                                        <div style="height: 100px; line-height: 100px; font-size: 10px;">&nbsp;</div>
